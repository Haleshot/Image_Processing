...
"padding-right:20px;")
        ...
        self.scrollArea = QScrollArea(Dialog_5)
    ...
    def retranslateUi(self, Dialog_5):
        ...
        self.Save_As.setText(QCoreApplication.translate("Dialog_5", u"Save As", None))
