...
"padding-right:20px;")
        ...
        self.scrollArea = QScrollArea(Dialog_4)
    ...
    def retranslateUi(self, Dialog_4):
        ...
        self.Save_As.setText(QCoreApplication.translate("Dialog_4", u"Save As", None))
